...
"""
All code is taken from the GitHub page for Cobolt Skyra. 
All code come from the python implementation of the software called pycobolt.
All code belongs to Cobolt.
"""
